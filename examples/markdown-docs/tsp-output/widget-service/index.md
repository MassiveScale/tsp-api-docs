...
| Type | Kind | Summary |
| --- | --- | --- |
| [AnalyzeResult](types/Analyze-Result.md) | Model | Result of analyzing a widget |
| [Error](types/Error.md) | Model | An error response |
| [Size](types/Size.md) | Enum | Size of a widget |
| [Widget](types/Widget.md) | Model | A widget is a small gadget that does something useful. |
| [WidgetList](types/Widget-List.md) | Model | List of widgets |
